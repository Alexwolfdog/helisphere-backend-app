...
const getUserList = async (req, res, next) => {
    ...
    try {
        ...
        const allUsers = await User.find().skip((req.query.page-1)*config.page.user.limit).limit(10);
          return res.status(200).json({
              success: true,
              statusCode: 200,
              data: allUsers,
    ...
    const users = await User.find(query).limit(10).skip((req.query.page-1)*config.page.user.limit);
      res.status(200).json({
        success: true,
        statusCode: 200,
        data: users,
